...
local width         = 26        -- width in pixels of progressbar
...
local step          = 0.02      -- stepsize for volume change (ranges from 0 to 1)
local color         = '#00ffff' -- foreground color of progessbar
local color_bg      = '#194747' -- background color
